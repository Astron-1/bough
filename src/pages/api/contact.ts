...
export default async function handler(
  ...
  const { name, email, company, city, country, phone, message } = req.body as ContactFormData

  // Validate required fields
  if (!name || !email || !company) {
    console.log('Missing required fields:', { name, email, company, city, country, phone, message })
