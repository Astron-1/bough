...
export default function TeamMemberPage() {
  ...
  if (router.isFallback || !id) {
    return (
      <div className="min-h-screen bg-[#f0f7ff] flex items-center justify-center">
        <Text type={Font.GARAMOND} className="text-xl">
          Loading...
        </Text>
      </div>
    );
  ...
  const memberBio =
    id && typeof id === "string" ? teamMembersBio[id] : undefined;
    ...
    return (
      <div className="min-h-screen bg-[#f0f7ff]">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 text-center">
          <Text type={Font.GARAMOND} className="text-3xl mb-6">
            ...
            <div className="mb-8">
              {member.linkedIn ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#0074FF] transition-colors"
                >
                  <Text
                    type={Font.GARAMOND}
                    className="text-3xl font-semibold mb-2 text-black"
                  >
                    {member.name}
                  </Text>
                </a>
