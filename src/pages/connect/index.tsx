  ...
  return (
    <main className="min-h-screen bg-[#f0f7ff] overflow-x-hidden relative w-full">
      ...
      <div className="relative">
        ...
        <div className="w-[496px] h-[594px] left-[-197px] top-[192px] absolute bg-[rgba(0,116,255,0.30)] shadow-[624px_624px_624px] rounded-full blur-[312px]"></div>
        <div className="w-[493px] h-[590px] right-[-100px] top-[157px] absolute bg-[rgba(0,116,255,0.30)] shadow-[624px_624px_624px] rounded-full blur-[312px]"></div>

        {/* Hero Section - 100vh height */}
        <div className="h-[calc(100vh-80px)] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex items-center">
          <div className="w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            ...
            <div className="lg:w-[55%] flex justify-center">
              <div className="w-[550px] relative bg-white rounded-[10px] shadow-[0px_8px_40px_0px_rgba(0,0,0,0.05)] overflow-hidden p-8">
                <form>
                  ...
                  <div className="mt-8 flex justify-center">
                    <button
                      type="submit"
                      className="w-[200px] h-[45px] bg-[#0052ff] text-white font-semibold text-lg rounded-full hover:bg-blue-600 transition-colors"
                    >
                      Connect
                    </button>
                  </div>
