                ...
                >
                  ...
                  >
                    <g clipPath="url(#clip0_us_flag)">
                      ...
                      />
                      <path
                        d="M19.1301 19.9999H39.9996C39.9996 18.1947 39.759 16.446 39.3107 14.7825H19.1301V19.9999Z"
                        fill="#D80027"
                      />
                      <path
                        d="M19.1301 9.5641H37.0642C35.8399 7.56629 34.2745 5.80043 32.4493 4.34668H19.1301V9.5641Z"
                        fill="#D80027"
                      />
                      <path
                        d="M19.9997 39.9999C24.7067 39.9999 29.033 38.373 32.4494 35.6521H7.55005C10.9665 38.373 15.2928 39.9999 19.9997 39.9999Z"
                        fill="#D80027"
                      />
                      <path
                        d="M2.93521 30.433H37.0643C38.0472 28.8292 38.8094 27.076 39.3108 25.2156H0.688721C1.19005 27.076 1.95231 28.8292 2.93521 30.433Z"
                        fill="#D80027"
                      />
                      <path
                ...
                >
                  ...
                  >
                    <g clipPath="url(#clip0_india_flag)">
                      ...
                      />
                      <path
                        d="M20.0001 -0.00146484C12.0709 -0.00146484 5.21962 4.61299 1.98462 11.3029H38.0155C34.7806 4.61299 27.9292 -0.00146484 20.0001 -0.00146484Z"
                        fill="#FF9811"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M20.0007 26.9552C23.8426 26.9552 26.9572 23.8407 26.9572 19.9987C26.9572 16.1568 23.8426 13.0422 20.0007 13.0422C16.1587 13.0422 13.0442 16.1568 13.0442 19.9987C13.0442 23.8407 16.1587 26.9552 20.0007 26.9552Z"
                        fill="#0052B4"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M20.0006 14.6348L21.3419 17.6768L24.6469 17.3173L22.6832 19.9999L24.6469 22.6825L21.3419 22.323L20.0006 25.3651L18.6593 22.323L15.3542 22.6824L17.318 19.9999L15.3542 17.3173L18.6593 17.6768L20.0006 14.6348Z"
                        fill="#0052B4"
                      />
                    </g>
                    <defs>
