              ...
              <div className="text-xl md:text-2xl flex items-center justify-center lg:justify-start mt-4 lg:mt-6">
                ...
                >
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_2_10021)">
                      <path d="M27.2655 27.266H22.5241V19.8406C22.5241 18.07 22.4925 15.7906 20.0581 15.7906C17.5886 15.7906 17.2108 17.7198 17.2108 19.7117V27.2655H12.4695V11.996H17.0211V14.0827H17.0849C17.5404 13.3039 18.1987 12.6631 18.9895 12.2288C19.7804 11.7944 20.6742 11.5827 21.5759 11.6161C26.3815 11.6161 27.2675 14.7771 27.2675 18.8893L27.2655 27.266ZM7.1195 9.90883C5.59988 9.90908 4.36775 8.67733 4.3675 7.1577C4.36725 5.63808 5.59888 4.40595 7.1185 4.4057C8.63812 4.40533 9.87025 5.63708 9.8705 7.1567C9.87063 7.88646 9.58087 8.58638 9.06497 9.1025C8.54906 9.61862 7.84925 9.90866 7.1195 9.90883ZM9.49025 27.2661H4.74388V11.996H9.49012L9.49025 27.2661ZM29.6293 0.00232899H2.36137C1.07262 -0.012171 0.01575 1.0202 0 2.30895V29.6906C0.01525 30.98 1.072 32.0133 2.36125 31.9998H29.6293C30.9213 32.0158 31.9821 30.9825 32 29.6906V2.30683C31.9816 1.01558 30.9206 -0.016671 29.6293 0.000203987" fill="#0A66C2"/>
                    </g>
                    <defs>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8">
            ...
            <div>
              <div className="flex items-center mb-4 justify-center md:justify-start">
                <div className="relative flag-icon" style={{ isolation: 'isolate' }}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg" 
                    width="40" 
                    height="40" 
                  ...
                  >
                    <g clipPath="url(#clip0_us_flag)">
                      ...
                      <path d="M19.1301 19.9999H39.9996C39.9996 18.1947 39.759 16.446 39.3107 14.7825H19.1301V19.9999Z" fill="#D80027"/>
                      <path d="M19.1301 9.5641H37.0642C35.8399 7.56629 34.2745 5.80043 32.4493 4.34668H19.1301V9.5641Z" fill="#D80027"/>
                      <path d="M19.9997 39.9999C24.7067 39.9999 29.033 38.373 32.4494 35.6521H7.55005C10.9665 38.373 15.2928 39.9999 19.9997 39.9999Z" fill="#D80027"/>
                      <path d="M2.93521 30.433H37.0643C38.0472 28.8292 38.8094 27.076 39.3108 25.2156H0.688721C1.19005 27.076 1.95231 28.8292 2.93521 30.433Z" fill="#D80027"/>
              ...
              <div className="flex items-center mb-4 justify-center md:justify-start">
                <div className="relative flag-icon" style={{ isolation: 'isolate' }}>
                  <svg
                    ...
                    className="mr-4"
                  >
                    <g clipPath="url(#clip0_india_flag)">
                      <rect width="40" height="40" rx="20" fill="white"/>
                      <path d="M20 40C31.0457 40 40 31.0457 40 20C40 8.9543 31.0457 0 20 0C8.9543 0 0 8.9543 0 20C0 31.0457 8.9543 40 20 40Z" fill="white"/>
                      <path d="M20.0001 -0.00146484C12.0709 -0.00146484 5.21962 4.61299 1.98462 11.3029H38.0155C34.7806 4.61299 27.9292 -0.00146484 20.0001 -0.00146484Z" fill="#FF9811"/>
                      ...
                      <path d="M20.0007 26.9552C23.8426 26.9552 26.9572 23.8407 26.9572 19.9987C26.9572 16.1568 23.8426 13.0422 20.0007 13.0422C16.1587 13.0422 13.0442 16.1568 13.0442 19.9987C13.0442 23.8407 16.1587 26.9552 20.0007 26.9552Z" fill="#0052B4"/>
                      ...
                      <path d="M20.0006 14.6348L21.3419 17.6768L24.6469 17.3173L22.6832 19.9999L24.6469 22.6825L21.3419 22.323L20.0006 25.3651L18.6593 22.323L15.3542 22.6824L17.318 19.9999L15.3542 17.3173L18.6593 17.6768L20.0006 14.6348Z" fill="#0052B4"/>
                    </g>
                    <defs>
                      <clipPath id="clip0_india_flag">
                        <rect width="40" height="40" rx="20" fill="white"/>
                      </clipPath>
                    </defs>
                  </svg>
