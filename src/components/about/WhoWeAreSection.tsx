...
import { createResponsiveVars, figmaSectionContainer } from "@app/utils/figmaUtils";
...
const TeamPhoto = ({ alt, src, placeholderText, className, style }: TeamPhotoProps) => (
  <div 
...
export default function WhoWeAreSection({ title, paragraphs, photos }: WhoWeAreSectionProps) {
  ...
  return (
    <div className="relative z-10 py-12 md:py-16 px-4 sm:px-6" style={figmaSectionContainer()}>
