    ...
    switch (caseStudy.iconType) {
      case 'finance':
        return (
          <div className="h-12 w-12 relative">
            ...
            <svg className="absolute inset-0 h-full w-full p-2.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case 'digital':
        return (
          <div className="h-12 w-12 relative">
            <div className="absolute inset-0 rounded-full bg-white/20"></div>
            <svg className="absolute inset-0 h-full w-full p-2.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 22H15M12 17V22M8 22H16M15.5 2H8.5C7.11929 2 6 3.11929 6 4.5V15.5C6 16.8807 7.11929 18 8.5 18H15.5C16.8807 18 18 16.8807 18 15.5V4.5C18 3.11929 16.8807 2 15.5 2Z" 
                stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        );
      case 'risk':
        return (
          <div className="h-12 w-12 relative">
            <div className="absolute inset-0 rounded-full bg-white/20"></div>
            <svg className="absolute inset-0 h-full w-full p-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    >
      ...
      >
        ...
        <div className="p-6 flex flex-col flex-grow">
          <h3 className="text-white text-[1.5rem] font-bold leading-[1.5rem] mb-2" style={{ fontFamily: "var(--font-sf-pro)" }}>
            {caseStudy.title}
          </h3>
          <h4 className="text-white/80 text-[1.1rem] font-semibold mb-4" style={{ fontFamily: "var(--font-sf-pro)" }}>
            {caseStudy.subtitle}
          </h4>
  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      description: 'At Bough, we understand that solving complex challenges goes beyond expertise. We helped this global institution modernize their financial operations, resulting in 45% reduction in processing time and $2.3M annual savings.',
      iconType: 'finance',
      bgColor: '#0c3b6a',
      accentColor: '#1e88e5',
    ...
    },
    {
      ...
      description: 'At Bough, we understand that solving complex challenges goes beyond expertise. Our digital transformation strategy helped this manufacturer achieve 60% increase in online sales and 30% improvement in supply chain efficiency.',
      iconType: 'digital',
      bgColor: '#2a1b5a',
      accentColor: '#9c27b0',
    ...
    },
    {
      ...
      description: 'At Bough, we understand that solving complex challenges goes beyond expertise. We implemented an enterprise risk management framework that reduced compliance incidents by 78% and improved operational resilience.',
      iconType: 'risk',
      bgColor: '#4a1c24',
      accentColor: '#ff5722',
      ...
      >
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="text-center mb-16">
            <h2 
              className="text-[2.8rem] font-bold leading-[3rem] text-white mb-4" 
              style={{ fontFamily: "var(--font-source-sans)" }}
            >
              Leveraging leading technologies to maximize impact
            </h2>
            <p className="text-white/80 text-xl max-w-3xl mx-auto">
              At Bough, we understand that solving complex challenges goes beyond expertise—it requires collaboration.
              That&apos;s why we continuously enhance our capabilities and forge strategic partnerships with leading technology
              providers and industry experts.
            </p>
          </div>
          
          <h3 
            className="text-center text-[2rem] font-semibold leading-[2.5rem] mb-12 text-white" 
            style={{ fontFamily: "var(--font-source-sans)" }}
          >
          ...
          <div className="mt-12 text-center">
            <Link 
              href="/case-studies" 
              className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 transition-colors rounded-lg text-white font-medium group overflow-hidden relative"
              style={{
