  ...
  const sections = [
    {
      ...
      description: "We believe in collaborative approaches that prioritize your specific needs and goals."
    },
    {
      title: "Empowering your workforce for sustainable change",
      icon: "/icons/empowerment.svg", 
      description: "We focus on equipping your teams with the skills and knowledge needed for long-term success and continuous improvement."
    },
    {
      title: "Technology that enhances, not replaces",
      icon: "/icons/technology.svg",
      description: "Our solutions integrate advanced technologies that complement human expertise rather than attempting to replace it."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-[#a3b3bc] max-w-4xl mx-auto text-lg">
            At Bough, we understand that solving complex challenges goes beyond expertise—it requires collaboration. That&apos;s why we continuously enhance our capabilities and forge strategic partnerships with leading technology providers and industry experts. By leveraging best-in-class digital capabilities, we deliver innovative, forward-looking solutions that drive measurable results.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <path 
              ...
              stroke={activeSection === 0 || activeSection === 1 || activeSection === 2 ? "#53fbfb" : "#13294c"} 
              strokeWidth="4" 
              fill="none" 
              strokeLinecap="round" 
            ...
            <circle 
              ...
              cy="120" 
              r="8" 
              fill={activeSection === 1 || activeSection === 2 ? "#53fbfb" : "#13294c"} 
              style={{ transition: "fill 0.5s ease" }}
            />
            ...
            <path 
              ...
              stroke={activeSection === 1 || activeSection === 2 ? "#53fbfb" : "#13294c"} 
              strokeWidth="4" 
              fill="none" 
              strokeLinecap="round" 
              strokeLinejoin="round"
            ...
            {sections.map((section, index) => (
              <div 
                ...
                style={{
                  ...
                  transform: activeSection === index ? "translateY(-10px)" : "translateY(0)"
                }}
              ...
              >
                ...
                <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none">
                  ...
                  <div 
                    ...
                    style={{
                      borderRight: activeSection === index ? "2px solid #53fbfb" : "2px solid rgba(83, 251, 251, 0.3)",
                      borderTop: activeSection === index ? "2px solid #53fbfb" : "2px solid rgba(83, 251, 251, 0.3)",
                  ...
                  <div 
                    ...
                    style={{
                      borderLeft: activeSection === index ? "2px solid #53fbfb" : "2px solid rgba(83, 251, 251, 0.3)",
                      borderBottom: activeSection === index ? "2px solid #53fbfb" : "2px solid rgba(83, 251, 251, 0.3)",
                      opacity: activeSection === index ? 1 : 0.5
                    }}
                  />
                  ...
                  <div 
                    ...
                    style={{
                      background: activeSection === index ? "#53fbfb" : "rgba(83, 251, 251, 0.3)",
                  ...
                  <div 
                    ...
                    style={{
                      background: activeSection === index ? "#53fbfb" : "rgba(83, 251, 251, 0.5)",
                      boxShadow: activeSection === index ? "0 0 10px #53fbfb" : "none"
                    }}
                  />
                ...
                <h3 className={`text-xl font-medium mb-5 transition-all duration-300 z-10 ${
                  activeSection === index ? "text-[#53fbfb]" : "text-white"
                }`}>
                  {section.title}
                </h3>
                <p className={`text-base transition-all duration-300 z-10 ${
                  activeSection === index ? "text-white opacity-100" : "text-white opacity-80"
                }`}>
                  {section.description}
                </p>
              </div>
